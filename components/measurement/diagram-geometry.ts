...
export const DIAGRAM_POINTS: DiagramPoint[] = [
  ...
  { key: "sleeve_length", side: "front", labelAr: "طول الكم", labelEn: "Sleeve Length", x: 257, y: 190, anchor: "start", dx: 10, dy: 2 },
  { key: "sleeve_width", side: "front", labelAr: "عرض الكم", labelEn: "Sleeve Width", x: 246, y: 90, anchor: "start", dx: 10, dy: 2 },
  { key: "wrist", side: "front", labelAr: "المعصم", labelEn: "Wrist", x: 263, y: 242, anchor: "start", dx: 10, dy: 2 },
  ...
  { key: "back_length", side: "back", labelAr: "الطول الخلفي", labelEn: "Back Length", x: 160, y: 430, anchor: "middle", dx: 0, dy: 14 },
