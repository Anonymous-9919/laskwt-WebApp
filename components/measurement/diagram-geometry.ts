...
export const DIAGRAM_POINTS: DiagramPoint[] = [
  ...
  { key: "shoulder", side: "front", labelAr: "عرض الكتفين", labelEn: "Shoulder Width", x: 76, y: 62, anchor: "end", dx: -10, dy: 2, referenceNumber: 1, guide: { x1: 76, y1: 72, x2: 245, y2: 72 } },
  ...
  { key: "sleeve_length", side: "front", labelAr: "طول الكم", labelEn: "Sleeve Length", x: 47, y: 190, anchor: "end", dx: -10, dy: 2, referenceNumber: 5, guide: { x1: 66, y1: 76, x2: 47, y2: 242 } },
  { key: "sleeve_width", side: "front", labelAr: "عرض الكم", labelEn: "Sleeve Width", x: 66, y: 96, anchor: "end", dx: -10, dy: 2 },
  ...
  { key: "bicep", side: "front", labelAr: "العضد", labelEn: "Bicep", x: 67, y: 130, anchor: "end", dx: -10, dy: 2 },
  { key: "front_length", side: "front", labelAr: "الطول الأمامي", labelEn: "Front Length", x: 160, y: 430, anchor: "middle", dx: 0, dy: 14 },
  { key: "back_length", side: "back", labelAr: "الطول الخلفي", labelEn: "Back Length", x: 160, y: 88, anchor: "middle", dx: 0, dy: -12, referenceNumber: 8, guide: { x1: 88, y1: 88, x2: 232, y2: 88 } },
