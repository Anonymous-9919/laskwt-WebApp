...
export const DIAGRAM_POINTS: DiagramPoint[] = [
  ...
  { key: "shoulder", side: "front", labelAr: "عرض الكتفين", labelEn: "Shoulder Width", x: 245, y: 72, anchor: "end", dx: -10, dy: 2, referenceNumber: 1, guide: { x1: 76, y1: 72, x2: 245, y2: 72 } },
  ...
  { key: "sleeve_length", side: "front", labelAr: "طول الكم", labelEn: "Sleeve Length", x: 257, y: 190, anchor: "end", dx: -10, dy: 2, referenceNumber: 5, guide: { x1: 66, y1: 76, x2: 47, y2: 242 } },
  ...
  { key: "bicep", side: "front", labelAr: "العضد", labelEn: "Bicep", x: 250, y: 130, anchor: "end", dx: -10, dy: 2 },
